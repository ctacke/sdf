...
namespace OpenNETCF.WindowsCE
{
	...
	/// </summary>
	public class TimeZoneCollection : List<TimeZoneInformation>
	{
            ...
            for (int i = 0; i < nZones; i++)
            {
                ...
                if (pZone != IntPtr.Zero)
                {
                        ...
                        (gmtOffset == ALL_TIMEZONES_LIST))
                    {
						...
						//jsm - Bug 235 - Copy Standard/Daylight Date in too
						tzi.StandardDate = tmpTZ.StandardDate;
						tzi.DaylightDate = tmpTZ.DaylightDate;
