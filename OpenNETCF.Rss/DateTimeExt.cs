...
namespace OpenNETCF.Rss
{
	...
	public static class DateTimeExt
	{
		...
		public static DateTime ToDateTime(string datetime)
		{
			...
			return XmlConvert.ToDateTime(datetime, XmlDateTimeSerializationMode.Unspecified);
		...
		public static DateTime Parse(string dateTimeString)
		{
			...
			if (m.Success)
			{
				...
				{
					throw new FormatException("ExceptionRFC2822ParseGroupsMessage", e);
				}
			}
			else
			{
		...
		private static DateTime AddOffset(string offsetOp, string datetime, int tzoneIndex)
		{
			...
			catch (IndexOutOfRangeException)
			{
				...
				throw new FormatException("ExceptionRFC2822InvalidTimezoneFormatMessage");
			}
