...
namespace OpenNETCF.Net.NetworkInformation
{
    ...
    */
    ...
    public class IPForwardEntry
    {
        ...
        public IPForwardEntry(NetworkInterface adapter) 
        {
        ...
        internal IPForwardEntry(byte[] data, int offset, NetworkInterface associatedAdapter)
        {
            m_data = new byte[SIZE];
        ...
        internal IPForwardEntry(byte[] data, int offset, NetworkInterface[] adapterList)
        {
            m_data = new byte[SIZE];
            Buffer.BlockCopy(data, offset, m_data, 0, SIZE);
            Metric2 = Metric3 = Metric4 = Metric5 = 0xffffffff;
