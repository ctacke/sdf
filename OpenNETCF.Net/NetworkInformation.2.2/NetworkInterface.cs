    ...
    public partial class NetworkInterface
    {
        ...
        public string Description
        {
            get
            {
                ...
                {
                    m_adapterInfo = GetAdapterInfo(m_index);
                }
        ...
        public OperationalStatus OperationalStatus
        {
            get 
            {
                if(m_mibifRow == null)
                {
                    m_mibifRow = GetMibIfRow(m_index);
                }
        ...
        public IPInterfaceProperties GetIPProperties()
        {
            ...
            if (m_mibifRow == null)
            {
                m_mibifRow = NetworkInterface.GetMibIfRow(m_index);
            }
...
/*
        ...
        protected const int MAX_ADAPTER_NAME = 256;
        ...
        /// <summary>
        /// Indicated whenther a NetworkInterfaceWatcher is currently attached to this NetworkInterface
        /// </summary>
        public bool IsBeingWatched
        {
            get { return m_isWatched; }
            internal set { m_isWatched = value; }
        }

        /// <summary>
        /// Gets a System.Boolean value that indicates whether the network interface is set to only receive data packets.
        /// </summary>
        public bool IsReceiveOnly { get { throw new System.PlatformNotSupportedException(); } }
...
/*
        ...
        {
            get { return m_adapterInfo == null ? "" : m_adapterInfo.GatewayList; }
            set
            {
                // Modify the registry keys associated with this
