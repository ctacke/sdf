...
namespace OpenNETCF.ComponentModel
{
    ...
    /// </summary>
    public class PrivateKeyLicenseProvider : LicenseProvider
    {
        #region fields
        ...
        public override License GetLicense(Type type, Assembly typeAssembly, LicenseResourceType resourceType, bool allowExceptions)
        {
            ...
            PrivateKeyLicense license = new PrivateKeyLicense(this, type);
            return license;
        }
        ...
        private class PrivateKeyLicense : License
        {
            #region fields
            ...
            private PrivateKeyLicenseProvider owner;
            ...
            public PrivateKeyLicense(PrivateKeyLicenseProvider owner, Type type)
            {
                  this.type = type;
                  this.owner = owner;
