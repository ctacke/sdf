	...
	public class DESCryptoServiceProvider : DES
	{
		public DESCryptoServiceProvider()
		{
			...
			try
			{
				...
				ipKey = OpenNETCF.Security.Cryptography.Internal.Key.GenKey(prov, Calg.DES, GenKeyParam.EXPORTABLE);
                this.Key = OpenNETCF.Security.Cryptography.Internal.Key.ExportSessionKey(prov, ipKey, 8, true);
