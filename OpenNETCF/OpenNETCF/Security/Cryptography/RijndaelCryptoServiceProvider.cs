...
namespace OpenNETCF.Security.Cryptography
{
	public class RijndaelCryptoServiceProvider : Rijndael
	{
		...
		{
            iv = OpenNETCF.Security.Cryptography.Internal.Rand.GetRandomBytes(16); //i think this is always 16 bytes
            key = OpenNETCF.Security.Cryptography.Internal.Rand.GetRandomBytes(16); //Aes128 by default
		}
