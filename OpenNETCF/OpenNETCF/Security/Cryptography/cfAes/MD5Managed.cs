...
namespace OpenNETCF.Security.Cryptography
{
	...
	/// </summary>
	public class MD5Managed : MD5, IDisposable
	{
		/* usage from ImClient sample
		/// <summary>
		...
		{
			//HACK web service call
			//Messenger m = new Messenger();
			//return m.GetMD5String(s);
			FlowGroup.Crypto.MD5 md5 = FlowGroup.Crypto.MD5.Create();
