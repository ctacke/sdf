/*
 * ---------------------------------------------------------
 * NetSHA.SHA384 .Net Framework implementation of SHA-384
 * 
 * by Jarrod Nelson for ECE 575 Project  
 * --------------------------------------------------------- 
 * Comments:
 * This class contains static methods which
 * implement SHA-384 either on a given file or on
...
namespace NetSHA
{
	...
	{
		//SHA-384 constants
		private const ulong _H00 = 0xcbbb9d5dc1059ed8;
		private const ulong _H10 = 0x629a292a367cd507;
		private const ulong _H20 = 0x9159015a3070dd17;
		private const ulong _H30 = 0x152fecd8f70e5939;
		private const ulong _H40 = 0x67332667ffc00b31;
		private const ulong _H50 = 0x8eb44a8768581511;
		private const ulong _H60 = 0xdb0c2e0d64f98fa7;
		private const ulong _H70 = 0x47b5481dbefa4fa4;

		/// <summary>
		/// This method take a byte array, pads it according to the 
		/// specifications in FIPS 180-2 and passes to the SHA-384
		...
		public static byte[] MessageSHA384( byte[] message )
		{
			int n, pBase;
			long l;
			byte[] m;
		...
		/// calls MessageSHA384 to pad and hash the message.  This
		...
		/// </param>
		/// <returns>Message hash value as byte array</returns>
		public static byte[] FileSHA384( string fileName )
		{
			byte[] m;
		...
		private static byte[] Hash384( int n, byte[] m )
		{
			// K Constants			
		...
		/// <summary>
		/// Performs SHA-384 logical functions.  See FIPS 180-2 for
		...
		/// <summary>
		/// Performs the SHA-384 shifting and rotating functions.
