...
//		private bool autoSize = false;
    ...
    public bool ShowFocusBorder { get; set; }
        ...
        {
            return !this.Font.Equals(DefaultFontValue);
        }
        #endregion ==================================================================================
      ...
      this.ShowFocusBorder = true;
        ...
        if (this.TransparentImage)
        {
          ...
          Color colorkey = (backgroundImage as Bitmap).GetPixel(0, 0);
          // Set the transparency key on the ImageAttributes object.
          attributes.SetColorKey(colorkey, colorkey);
          presentation.DrawImage(backgroundImage, destinationRect, 0, 0, sourceRect.Width, sourceRect.Height, GraphicsUnit.Pixel, attributes);
        }
        else
        {
          presentation.DrawImage(backgroundImage, destinationRect, sourceRect, GraphicsUnit.Pixel);
			...
			// should be painted.
			if (((this.Focused) || (this.IsDefault)) && ShowFocusBorder)
			{
