...
namespace OpenNETCF.Windows.Forms
{
    ...
    public partial class CheckBox2 : Control, IWin32Window
    {
		...
		//jsm - Bug 176: Setting CheckBox2 Text (when up-cast to Control) doesn't hold effect
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //New functionality for drawing a focus rectangle 
#if SDF21
            if(this.Focused && this.DrawFocusedRectangle)
                DrawFocusRectangle(checkRect, textRect);
#endif
